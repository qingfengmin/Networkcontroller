...
class ospf_auto:
    ...
    def ospf_config(self, process, area_id):
        ...
        # self.__add_xml(config().interface_addrsss(f'Loopback0',loopback_ip, choice(self.loopback_mask)))
        self.__add_xml(config().ospf_Process(process, loopback_ip, area_id))
